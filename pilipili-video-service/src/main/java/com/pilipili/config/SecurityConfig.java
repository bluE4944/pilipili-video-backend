...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .antMatchers("/api/video/page", "/api/video/page/mixed", "/api/video/{videoId}", "/api/video/search/**", "/api/video/play/url/**", "/api/video/play/count/**", "/api/video/stream/**", "/api/video/danmaku/{videoId}", "/api/cover/**", "/api/auth/login", "/api/dict/**").permitAll()
                // 公开接口：视频统计（部分）
